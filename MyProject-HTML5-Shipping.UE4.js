...
var Module = {
	...
	UE4_indexedDBVersion: 202309271442, // Bump this number to invalidate existing IDB storages in browsers.
};
...
//	}
	...
	function withIndexedDB(db) {
		...
		var mainCompiledCode = fetchFromIndexedDB(db, 'wasmModule').then(function(wasmModule) {
			...
			return download(Module.locateFile('https://dl.dropboxusercontent.com//scl/fi/9d14fni9ox2fwyprb60io/UE4Game-HTML5-Shipping.wasm?rlkey=me0jh4p3rbek46ejj6hlgizc2&dl=0'), 'arraybuffer').then(function(wasmBytes) {
		...
		// ----------------------------------------
		// MAIN JS
		var mainJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/leshamet/TildaTest/9ef635ec773597efb645048441ca39edc5dde01f/UE4Game-HTML5-Shipping.js'), 'blob').then(function(data) {
		...
		// ----------------------------------------
		// MORE JS
		var dataJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/leshamet/TildaTest/bb70b321cf604b3dc57be462fa1a406e9b797761/MyProject-HTML5-Shipping.data.js'));
		var utilityJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/leshamet/TildaTest/8bc0387c6fc4aa9d78fdb1a857f4c1f6eff72148/Utility.js')).then(addScriptToDom);
		var dataDownload =
...
// Instead as a fallback, download as ArrayBuffer. (TODO: Figure out the bugs with the above, and switch to using that one instead)
			fetchOrDownloadAndStore(db, Module.locateFile('https://dl.dropboxusercontent.com/scl/fi/b4l1cblb0qg7y9ujy60hs/MyProject-HTML5-Shipping.data?rlkey=jlpz9uki7jp9kf8mlw5j70pkv&dl=0'), 'arraybuffer').then(function(dataArrayBuffer) {
				Module['preloadedPackages'] = {};
				Module['preloadedPackages'][Module.locateFile('https://dl.dropboxusercontent.com/scl/fi/b4l1cblb0qg7y9ujy60hs/MyProject-HTML5-Shipping.data?rlkey=jlpz9uki7jp9kf8mlw5j70pkv&dl=0')] = dataArrayBuffer;
				return dataJsDownload.then(addScriptToDom);
			});
